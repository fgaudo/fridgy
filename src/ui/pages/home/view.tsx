...
import type { Model } from '@/app/ports/state-manager/model-emitter/pages/home/model.ts'
				...
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					<div className="mx-auto max-w-2xl lg:text-center">
						<h2 className="text-base/7 font-semibold text-red-300">
							13 1232 aaa d11 3 111 31 11Deploy faster
						</h2>
						<p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance">
							s Everything you need to deploy your app
						</p>
						<p className="mt-6 text-lg/8 text-gray-700">
							d s da1Quis tellus eget adipiscing convallis sit sit eget aliquet
